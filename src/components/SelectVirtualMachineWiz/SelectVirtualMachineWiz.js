...
class SelectVirtualMachineWiz extends Component {
    constructor(props) {
        super(props)
              ...
              {this.props.open ? (<div className="freeze">
                  <div className="pop-up-windowsmall">
                      <div className="pop-up-header">
                        <div className="gt-left pop-up-h-title">Select virtual machine</div>
                      ...
                      <div className="body-popup3 gt-clear">
                        <div className="gt-clear heigth30px">
                          ...
                          <div className="searchiccont"><input type="text" placeholder="Search"/><input type="button" className="search-icon-jh" value=""/></div>
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectVirtualMachineWiz);
